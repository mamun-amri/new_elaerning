    ...
    <tbody>
        ...
        <tr>
            <td colspan=\"2\">
                ";
        // line 21
        if (($this->getAttribute((isset($context["siswa"]) ? $context["siswa"] : null), "foto") != "")) {
            // line 22
            echo "                <a href=\"";
            echo twig_escape_filter($this->env, site_url(((("siswa/delete_foto/" . (isset($context["siswa_id"]) ? $context["siswa_id"] : null)) . "/") . enurl_redirect(current_url()))), "html", null, true);
...
";
    ...
    {
        return array (  77 => 29,  70 => 24,  64 => 22,  62 => 21,  54 => 16,  47 => 12,  39 => 7,  34 => 5,  31 => 4,  28 => 3,);
    }
}
